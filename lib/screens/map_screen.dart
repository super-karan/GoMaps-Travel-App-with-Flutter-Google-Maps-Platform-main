...
class _MapScreenState extends ConsumerState<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ref.watch(directionsProvider(origin, destination.name)).maybeWhen(
                ...
                SizedBox(
                  ...
                  child: GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      target: LatLng(
                        directions.route[0].latitude,
                        directions.route[0].longitude,
                      ),
                      zoom: 12,
                    ),
                  ),
...
class PointOfInterestDetails extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ref
        .watch(placeDetailsProvider(destination.name, destination.latLng))
        .maybeWhen(
